...
#python image_collection.py --urls sadio_mane_urls.txt --output sadio_mane
...
ap.add_argument("-u", "--urls", required=True, help="~/projects/monet_or_manet/sadio_mane_urls.txt")
ap.add_argument("-o", "--output", required=True, help="~/projects/monet_or_manet/images/raw/sadio_mane")
