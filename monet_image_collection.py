...
#python image_collection.py --urls monet_urls.txt --output monet
...
ap.add_argument("-u", "--urls", required=True, help="~/projects/monet_or_manet/monet_urls.txt")
ap.add_argument("-o", "--output", required=True, help="~/projects/monet_or_manet/images/raw/monet")
